...
const (
	...
	AlreadyOwned               string = "already-owned"
	...
	InvalidChoice              string = "invalid-choice"
	...
	RegisterWindow             string = "register-window"
	Required                   string = "required"
	ReservedName               string = "reserved-name"
	...
	RevokedName                string = "revoked-name"
