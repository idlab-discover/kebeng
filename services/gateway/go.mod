...
require (
	...
	github.com/idlab-discover/kebeng/services/assertion v0.0.0-20250325112841-7150606707e2
	github.com/idlab-discover/kebeng/services/store v0.0.0-20250406124448-e852a45ba809
