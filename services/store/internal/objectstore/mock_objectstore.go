...
func (m *MockObjectStore) SaveFileToBucket(bucket string, filePath string, sha3_384_encoded string, name string, version string, fileType string, summary string, description string, confinement string, base string, architectures []string) (*models.Metadata, error) {
	args := m.Called(bucket, filePath, sha3_384_encoded, name, version, fileType, summary, description, confinement, base, architectures)
	if args.Get(0) != nil {
